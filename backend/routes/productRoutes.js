...
productRouter.put(
  ...
  expressAsyncHandler(async (req, res) => {
    ...
    if (product) {
      product.customId = ((req.body.brand + req.body.name + Date.now()).replace(/\s+/g, '')).toLowerCase()
      ...
      product.tone = req.body.tone;
      product.first = req.body.first;
      product.mid = req.body.first;
      product.end = req.body.end;
      product.year = req.body.year;
      product.age = req.body.age;
      product.odor = req.body.odor;
